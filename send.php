...
$mail->Port     = 587;
// Sender info 
$mail->setFrom('info@omexaindia.com', 'Omexa Logistic Packers and Movers'); 
$mail->addReplyTo('info@omexaindia.com', 'Test Email'); 
 
// Add a recipient 
$mail->addAddress('omexaindia@gmail.com'); 
...
$mailContent = ' 
    ...
    <p>Omexa Logistic Packers and Movers</p>';  
...
if(!$mail->send()){ ?>
    ...
    window.location.href="https://omexaindia.com/thank-you.html";
    </script>
    // 
    <?php
